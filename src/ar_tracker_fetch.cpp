...
bool fetch_alvarMarkers_Callback(aubo_robot_base::fetch_marker_id::Request  &req,
...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "ar_tracker_fetch");
    ros::NodeHandle n;
    ...
    ros::ServiceServer fetch_service = n.advertiseService("/fetch_alvarMarkers", fetch_alvarMarkers_Callback);
